...
const Dashboard: React.FC = () => {
  ...
  const loadDashboardData = async () => {
    ...
    try {
      // Load statistics
      const [projectsData, testCasesData, executionsData, reportsData] = await Promise.all([
      ...
      const passedCount = executionsData.list.filter(exec => exec.status === 'success').length;
      const totalCount = executionsData.list.length;
